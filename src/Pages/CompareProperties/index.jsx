        ...
        <Box className="compareProjectBox">
          ...
          <Box className="productInfoBox">
            ...
            {TinBox(
              ...
              "Courtyard, Cable readyt",
              "Courtyard, Air Conditioning"
            )}
            {WhiteBox(
              "Features",
              "Trash removal, Lighting system",
              "Photography, Green Screen Room",
              "Photography, Green Screen Room"
            )}
            {TinBox(
              "Do’s & Don’ts",
