      ...
      <Box className="footer">
        <Box className="footerMainBody">
          <Box className="footerBox">
            <Box className="footerItem footerCologos">
              <img
                style={{ width: "138px", height: "24px", marginBottom: "20px" }}
                src={spotlet}
              />
              <Typography className="footerLogoSubText">
                SpotLet is a platform where hosts, guests, clients and customers
                come together to find their dream spaces. It’s a collaboration
                of ideas, places and people to create beautiful moments and
                memories.
              </Typography>
            </Box>

            <Box className="footerItem">
              <Typography className="footerItemHeader">COMPANY</Typography>
              <Box className="footerSubItem">
                ...
                <Box className="footerSubText">
                  <Link
                    className="linkTag"
                    to={"http://localhost:3000/careers"}
                  >
                    <img className="RightArrow" src={RightArrow} />
                ...
                <Box className="footerSubText">
                  <Link
                    className="linkTag"
                    to={"http://localhost:3000/blog/Details"}
                  >
                    <img className="RightArrow" src={RightArrow} />
            ...
            <Box className="footerItem">
              <Typography className="footerItemHeader">HOST</Typography>
              <Box className="footerSubItem">
                <Box className="footerSubText">
                  <img className="RightArrow" src={RightArrow} />
            ...
            <Box className="footerItem">
              <Typography className="footerItemHeader">EXPLORE</Typography>
              <Box className="footerSubItem">
                <Box className="footerSubText">
                  <img className="RightArrow" src={RightArrow} />
            ...
            <Box className="footerItem">
              <Typography className="footerItemHeader">SUPPORT</Typography>
              <Box className="footerSubItem">
                <Box className="footerSubText">
                  <img className="RightArrow" src={RightArrow} />
                ...
                <Box className="footerSubText">
                  <Link
                    className="linkTag"
                    to={"http://localhost:3000/Terms-and-Conditions"}
                  >
                    <img className="RightArrow" src={RightArrow} />
        ...
        <Box className="footerSubBody">
          ...
          <Box className="socialMediaBox">
            <a href="https://www.facebook.com/SpotLetIN" target="_blank">
              <img src={FacebookIcon} />
            </a>
            <a href="https://twitter.com/SpotLetIN" target="_blank">
              <img src={TwitterIcon} />
            </a>
            <a
              href="https://www.linkedin.com/company/spotletin/"
              target="_blank"
            >
              <img src={LinkedinIcon} />
            </a>
            <a href="https://www.instagram.com/spotletin/" target="_blank">
              <img src={InstgramIcon} />
            </a>
            <a href="https://in.pinterest.com/SpotLetIN/" target="_blank">
              <img src={PinterestIcon} />
            </a>
            <a href="https://www.youtube.com/@spotlet" target="_blank">
              <img src={YouTubeIcon} />
            </a>
          </Box>
        </Box>
